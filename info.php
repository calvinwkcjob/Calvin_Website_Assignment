        ...
        <div class="container">
            ...
            <nav class="main-menu">
                <ul>
                    ...
                    <li><a class='external current' href="info.php">Drugs Details</a></li>
    ...
    <div class="container">
      <section class="col-md-12 content" id="home">
	        <div class="col-lg-12 col-md-12 content-item" style="padding-bottom:20px">	        
		        ...
		        <div class="col-lg-12 col-md-12 content-item"><h2 class="main-title text-center dark-blue-text" style="font-size:56px;">Drugs Details</h2></div>	        
	        <div class="col-lg-12 col-md-12 content-item" style="padding-bottom:20px">
        ...
        <div id="accordion">
          ...
          if (mysqli_num_rows($result) > 0) {
              ...
              while($row = mysqli_fetch_assoc($result)) {
                  ...
                  echo "<h3>".$row["name"]."</h3>";
                  echo "<div><p>Type: ".$row["type"]."</p>";
                  echo "<p>".$row["detail"]."</p>";
                  echo "<p style='color:red;'>Effects:<br />".$row["effects"]."</p></div>";
